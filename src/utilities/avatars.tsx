...
export const avatars: Avatar[] = [
    ...
    { name: 'rocky', image:'rock-sprite', type: 'r', unlockRequirement: {unlockType: 'amount', field: 'gamesWon', amount:5}},
    { name: 'papo', image:'paper-sprite', type: 'p', unlockRequirement: {unlockType: 'amount', field: 'gamesWon', amount:5}},
    { name: 'scizzy', image:'scissors-sprite', type: 's', unlockRequirement: {unlockType: 'amount', field: 'gamesWon', amount:5}},
    ...
    { name: 'rock star', image:'rockStar', type: 'r', unlockRequirement: {unlockType: 'amount', field: 'gamesWon', amount:50}},
    { name: 'paper pusher', image:'paper3', type: 'p', unlockRequirement: {unlockType: 'amount', field: 'tourneysPlayed', amount:10}},
    ...
    { name: 'stonewall jackson', image:'stonewall', type: 'r', unlockRequirement: {unlockType: 'pay', field: '$', amount:.99}},
    ...
    { name: 'origamier', image:'origamier', type: 'p', unlockRequirement: {unlockType: 'pay', field: '$', amount:.99}},
    { name: 'b2-holePunch', image:'b2-holepunch', type: 'p', unlockRequirement: {unlockType: 'pay', field: '$', amount:.99}},
